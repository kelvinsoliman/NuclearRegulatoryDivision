...
const RSDSInformation = () => {
  ...
  const fetchGuides = async () => {
    try {
      const response = await fetch("http://localhost:5175/RSDSInformation");
      if (!response.ok) {
          ...
          <div className="lg:w-2/3" data-aos="fade-left">
            ...
            <div className="max-w-lg mx-auto mb-8" data-aos="fade-up">
              <div className="relative">
                <input
                  type="text"
                  placeholder="Search information notices..."
                  value={searchQuery}
...
export default RSDSInformation;