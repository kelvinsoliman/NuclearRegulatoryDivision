  ...
  return (
    <nav className="bg-white border-gray-200 shadow-xl">
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        ...
        >
          <ul className="flex text-sm flex-col font-medium p-4 md:p-0 mt-4 border md:space-x-2 md:flex-row md:mt-0 md:border-0">
            {/* Home Dropdown */}
            <li className="relative group">
              <button
                onClick={() => setIsHomeDropdownOpen(!isHomeDropdownOpen)}
                className="flex items-center justify-between w-full p-2 px-3 text-black rounded-lg hover:bg-slate-200 md:hover:text-blue-700"
              >
                Home
                <svg
            ...
            <li>
              <Link 
                to="/Regulations" 
                className="block p-2 px-3 text-black rounded-lg hover:bg-slate-200"
              >
                Regulations
              </Link>
            </li>
            ...
            <li className="relative group">
              <button
                onClick={() => setIsSeeMoreDropdownOpen(!isSeeMoreDropdownOpen)}
                className="flex items-center justify-between w-full p-2 px-3 text-black rounded-lg hover:bg-slate-200 md:hover:text-blue-700"
              >
                See More
                <svg
              ...
              {isSeeMoreDropdownOpen && (
                <ul className="absolute z-50 left-0 mt-1 w-48 bg-white shadow-md rounded-lg py-2">
                  <li>
                    <Link
                      to="/RSDSBulletin"
                      className="block px-4 py-2 text-black hover:bg-gray-100"
