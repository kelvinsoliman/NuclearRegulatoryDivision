...
const ReviewEvaluation = () => {
  ...
  const responsibilities = [
    { title: "Application Review", description: "Evaluating nuclear license applications for regulatory compliance and safety standards.", icon: "📑" },
    { title: "Risk and Safety Assessment", description: "Conducting thorough risk assessments to ensure public and environmental safety.", icon: "⚠️" },
    { title: "Regulatory Compliance", description: "Ensuring all nuclear activities adhere to established laws and guidelines.", icon: "✅" },
    { title: "Ongoing Monitoring", description: "Regular inspections and compliance checks for licensed nuclear facilities.", icon: "📊" }
  ];
    ...
    <div className="bg-gray-100 text-gray-900">
      ...
      <section className="container mx-auto px-6 py-16 flex flex-col md:flex-row items-center md:items-start gap-10">
        ...
        <div className="max-w-4xl mx-auto p-6" data-aos="fade-left">
          <h1 className="text-3xl font-bold text-blue-600">Licensing Review & Evaluation</h1>
          <p className="mt-2 text-gray-600">
            The Nuclear Regulatory Division (NRD) is responsible for reviewing and evaluating licensing applications for nuclear facilities and radioactive materials. Our goal is to ensure compliance with safety standards and protect public health and the environment.
          </p>

          <div className="mt-6 border rounded-lg overflow-hidden shadow-lg" data-aos="fade-up">
            <div className="bg-slate-900 text-white p-4 font-bold">Review & Evaluation Process</div>
            <ul className="divide-y divide-gray-300">
              {reviewProcess.map((step, index) => (
                <li key={index} className="flex items-center p-4 bg-gray-100 hover:bg-gray-200">
      ...
      <section className="mt-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 mt-6 mb-10 mx-auto max-w-[1440px]">
          {responsibilities.map((item, index) => (
            <div key={index} className="bg-white p-6 rounded-xl shadow-lg border-l-4 border-blue-500 flex items-start space-x-4" data-aos="fade-up" data-aos-delay={index * 200}>
