...
const AdminServices = () => {
  ...
  useEffect(() => {
    ...
    const fetchLicenses = async () => {
      setLoading(true);
      try {
        const res = await fetch("http://localhost:5175/LresServices");
  ...
  const handleSubmit = async (e) => {
    ...
    const url = "http://localhost:5175/AdminServices";
    ...
    <div className="min-h-screen bg-gray-100 p-6">
      ...
      <div className="bg-white rounded-lg shadow-md overflow-hidden">
        <div className="p-4 flex justify-between items-center">
          ...
          <button
            onClick={() => {
              setFormData({ service_name: "", service_desc: "", requirements: "", details: "" }); // Reset form
              ...
              <tr key={index}>
                ...
                <td className="px-6 py-4 flex">
                  <button
                    ...
                    className="px-3 w-[100px] py-1 bg-yellow-500 text-white rounded-md hover:bg-yellow-600 focus:outline-none focus:ring-2 focus:ring-yellow-500 focus:ring-offset-2"
                  >
                    Edit
                  </button>
                  <button
                    onClick={() => handleDelete(index)}
                    className="ml-2 w-[100px] px-3 py-1 bg-red-600 text-white rounded-md hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2"
                  >
                    Delete
                  </button>
                </td>
